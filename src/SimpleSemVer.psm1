...
function Set-SimpleSemVer {
    ...
    function GenerateXmlTemplate {
        ...
        $XmlWriter.WriteComment('Use this only to store and set version information in your program')
        $XmlWriter.WriteComment('You should not include this file in your release files')
